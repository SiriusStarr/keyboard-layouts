...
const uint16_t PROGMEM keymaps[DYNAMIC_KEYMAP_LAYER_COUNT][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MH_AUTO_BUTTONS_LAYER] = LAYOUT(
             /*Center           North            East                    South           West*/
        /*R1*/ KC_RSFT,         _______,         _______,                KC_BTN1,        _______,
        /*R2*/ KC_RCTL,         _______,         _______,                KC_BTN3,        _______,
        /*R3*/ KC_RALT,         _______,         _______,                KC_BTN2,        _______,
        /*R4*/ KC_RGUI,         _______,         _______,                _______,        _______,
        /*L1*/ KC_LSFT,         _______,         SV_RECALIBRATE_POINTER, KC_BTN1,        _______,
        /*L2*/ KC_LCTL,         _______,         _______,                KC_BTN3,        _______,
        /*L3*/ KC_LALT,         _______,         _______,                KC_BTN2,        _______,
        /*L4*/ KC_LGUI,         _______,         _______,                _______,        _______,
             /*Down             Inner (pad)      Upper (Mode)            O.Upper (nail)  OL (knuckle) Pushthrough*/
        /*RT*/ KC_MS_WH_UP,     KC_MS_WH_DOWN,   _______,                _______,        _______,     _______,
        /*LT*/ KC_MS_WH_UP,     KC_MS_WH_DOWN,   _______,                _______,        _______,     _______
        )
